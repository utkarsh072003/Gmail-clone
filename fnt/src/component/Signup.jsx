...
const Signup = () => {
   ...
   const submitHandler= async(e)=>{
      e.preventDefault();
      try {
        const res = await axios.post("https://gmail-clone-3-cfsb.onrender.com/api/v1/user/register", input, 
          {headers:{
  ...
  return (
    ...
    <div className='flex items-center justify-center w-screen h-screen'>
       <form onSubmit={submitHandler} className='flex flex-col gap-3 bg-white p-4 w-[20%]'>
        ...
        <button type='submit' className='bg-blue-300 p-2 text-gray-800 my-2 rounded-md'>Signup</button>
